...
join_tibbles <- function(years = list(...), num_var_list = 
  ...
  tibble_1 <- url_to_tibble(pums_url_builder(year = years[[1]], num_var_list[[1]] = num_vars,
                            cat_var_list[[1]] = cat_vars, geo_lev_list[[1]] = geo_lev,
                            geo_lev_value_list[[1]] = geo_lev_value))
  tibble_2 <- url_to_tibble(pums_url_builder(year = years[[2]], num_var_list[[2]] = num_vars,
