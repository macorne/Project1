...
pums_big_tib <- function(years = NULL) {
  ...
  for (i in years) {
    num_question_by_year[i] <- readline(paste0("How many numerical variables do you want 
                                        to query for year ", i, "? Enter a positive 
                                        integer: "))
    num_input <- c()
    ...
    cat_question_by_year[i] <- readline(paste0("How many categorical variables do you want 
                                        to query for year ", i, "? Enter a positive 
                                        integer: "))
    cat_input <- c()
    ...
    geo_lev_by_year[i] = readline(paste0("Enter a geography level for year ", i, 
                                         ": "))
    geo_question_by_year[i] = readline("Would you like to also enter a value for 
                                       the geography level for this year? Enter
                                       \'yes\' or \'no\': ")
    if (geo_question_by_year[i] == "yes") {
      geo_lev_value_by_year[i] = readline(paste0("Enter a value for the geography
                                                  level for year ", i, ": "))
    }
    else {
...
Success! Now we need to add a class for out big tibble.
...
pums_big_tib <- function(years = NULL) {
  ...
  for (i in years) {
    num_question_by_year[i] <- readline(paste0("How many numerical 
    variables do you want to query for year ", i, "? Enter a positive 
                                               integer: "))
    num_input <- c()
    for (j in 1:num_question_by_year[i]) {
      num_input[j] <- readline(paste0("Enter a numerical value for 
                                      year", i, ": "))
    }
    num_vars_by_year[[i]] <- num_input
    
    cat_question_by_year[i] <- readline(paste0("How many categorical 
                                               variables do you want to 
                                               query for year ", i, "? 
                                               Enter a positive integer
                                               : "))
    cat_input <- c()
    for (j in 1:cat_question_by_year[i]) {
      cat_input[j] <- readline(paste0("Enter a categorical value for 
                                      year ", i, ": "))
    }
    cat_vars_by_year[[i]] <- cat_input
    
    geo_lev_by_year[i] = readline(paste0("Enter a geography level for 
                                         year ", i, ": "))
    geo_question_by_year[i] = readline("Would you like to also enter a 
    value for the geography level for this year? Enter 
                                       \'yes\' or \'no\': ")
    if (geo_question_by_year[i] == "yes") {
      geo_lev_value_by_year[i] = readline(paste0("Enter a value for the
      geography level for year ", i, ": "))
    }
    else {
      geo_lev_value_by_year[i] = NULL
    }
  ...
  class(big_tib) <- c("census", big_tib)

  return (big_tib)
}

summary.census <- function(pums_big_tib, num_vars, cat_vars) {
